...
<body>
    ...
    <div class="notices" id="cashs" style="display: none;z-index:99;">
        ...
        <div class="content a">
            <div style="text-align:center;margin-top:3vw;">提现金额<?php echo $user['yongjin']; ?>元，手续费<?php echo config('site.tixian_bili')*$user['yongjin']; ?>元</div>
                ...
                <div class="content">
                    <div class="hd">
                        ...
                        <div class="info">
                            ...
                            <div class="sub"><span>ID：<?php echo $user['id']; ?></span></div>
                        </div>
                        <a href="javascript:;" class="link"><i class="iconfont">&#xe60a;</i>收益提现</a>
                    </div>
                    <div class="bd">
                        <div class="item">
                            <div class="title"><i>￥</i><?php echo $user['jine']; ?></div>
                            <p class="sub">我的余额</p>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="title"><?php echo $user['fudai']; ?><i> 个</i></div>
                            <p class="sub">我的福袋</p>
                        </div>
                        <!-- <div class="item">
